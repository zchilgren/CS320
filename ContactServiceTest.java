...
public class ContactServiceTest {
	...
	void newContactTest) {
		...
		assertAll(
				...
				()
					-> assertEquals("123559999",service.getContactList().get(0).getPhoneNumber()),
				()
	...
	assertAll(
			"service",
			()
				-> assertNotNull(service.getContactList().get(3).getContactld()),
			()
	...
	assertAll(
			...
			()
				-> assertEquals(phoneNumbereTest,service.getContactList().get(4).getPhoneNumber()),
			()
	...
	void updatePhoneNumber() throws Exception {
		...
		assertThrows(IllegalArgumentException.class,
			()
				-> service.updateFirstName(service.getContactList().get(0).getContactId(),tooLongPhoneNumber));
		assertThrows(IllegalArgumentException.class,
			()
				-> service.updateFirstName(service.getContactList().get(0).getContactId(),tooShortPhoneNumber));
			assertThrows(IllegalArgumentException.class,
			()
				-> service.updateFirstName(service.getContactList().get(0).getContactId(),null));
		assertThrows(Exception.class,
